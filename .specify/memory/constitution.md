...
**Rationale**: Environment variables separate configuration from code. NEXT*PUBLIC* prefix makes client-side exposure explicit. Excluded .env.local prevents accidental secret commits.
