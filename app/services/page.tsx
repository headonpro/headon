...
export const metadata: Metadata = {
  ...
  description:
    'Professionelle Digitallösungen von HEADON: Web Development mit Next.js, Mobile Apps für iOS/Android, UI/UX Design und Backend-Entwicklung. End-to-End Service für Ihr digitales Projekt.',
  keywords:
