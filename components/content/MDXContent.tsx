...
import { HighlightBox, StatHighlight } from '@/components/content/HighlightBox'
...
export default function MDXContent({ children }: MDXContentProps) {
  return (
    <div className="prose prose-lg prose-headings:font-heading prose-headings:text-gray-900 prose-p:text-gray-900 prose-p:leading-relaxed prose-a:!text-primary prose-a:!no-underline hover:prose-a:underline prose-strong:text-gray-900 prose-strong:font-semibold prose-code:!bg-gray-900 prose-code:!text-gray-100 prose-code:!px-1.5 prose-code:!py-0.5 prose-code:!rounded prose-pre:!bg-gray-900 prose-pre:!text-gray-100 prose-blockquote:border-l-primary prose-blockquote:text-gray-900 max-w-none [&_h2]:mt-24 [&_h2]:mb-12 [&_h2]:text-3xl [&_h2]:pl-6 [&_h2]:border-l-4 [&_h2]:border-l-primary-600 [&_h2]:pb-4 [&_h3]:mt-16 [&_h3]:mb-6 [&_h3]:text-2xl [&_h3]:font-bold [&_h4]:mt-12 [&_h4]:mb-6 [&_h4]:text-xl [&_ol]:my-10 [&_ol_li]:mb-4 [&_p]:mb-8 [&_p]:text-lg [&_p]:leading-relaxed [&_ul]:my-10 [&_ul_li]:mb-4">
      {children}
    </div>
  )
}
