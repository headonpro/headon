  ...
  return (
    <div className={cn('relative inline-block', className)}>
      ...
      >
        ...
        <svg
          className="lightning-bolt lightning-1 absolute -top-1 left-0 h-3 w-3"
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
        ...
        <svg
          className="star-spark star-1 absolute -top-0.5 left-2 h-2.5 w-2.5"
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
        ...
        <svg
          className="lightning-bolt lightning-2 absolute right-0 -bottom-1 h-2.5 w-2.5"
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
        ...
        <svg
          className="star-spark star-2 absolute bottom-0 left-1 h-2 w-2"
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
        ...
        <svg
          className="lightning-bolt lightning-3 absolute top-1/2 -right-1 h-2 w-2 -translate-y-1/2"
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
        ...
        <svg
          className="star-spark star-3 absolute top-0.5 right-0.5 h-3 w-3"
          viewBox="0 0 24 24"
          fill="none"
        >
          <path
        ...
        <div className="electric-text-glow absolute inset-0" />
      </div>
      ...
      <div className="absolute inset-0 opacity-0 transition-opacity duration-200 hover:opacity-100">
        ...
        >
          ...
          <svg
            className="lightning-surge absolute top-0 left-1/2 h-4 w-4 -translate-x-1/2"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
