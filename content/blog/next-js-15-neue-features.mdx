...
<KeyTakeaways
  items={[
    { text: "Partial Prerendering (PPR) kombiniert SSG und SSR für optimale Performance", highlight: true },
...
<InfoBox type="info">
Next.js 15 nutzt intelligente Analyse-Algorithmen, um häufig gemeinsam genutzte Module in optimale Chunks zu gruppieren. Das reduziert Redundanz und verbessert Caching.
</InfoBox>
