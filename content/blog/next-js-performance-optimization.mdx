...
description: 'Steigern Sie Ihren Lighthouse-Score auf 90+: Code-Splitting, Image Optimization, Caching und moderne Performance-Patterns für Next.js Anwendungen.'
...
```tsx
// ❌ Direktes <img> Tag (keine Optimierung)
<img src="/large-image.jpg" />

// ✅ next/image (automatische Optimierung)
<Image
  src="/large-image.jpg"
  width={800}
  height={600}
