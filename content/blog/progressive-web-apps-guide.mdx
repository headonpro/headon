...
export function PushNotificationSubscribe() {
  ...
  return <Button onClick={subscribe}>Benachrichtigungen aktivieren</Button>
}
```
...
export function InstallPrompt() {
  ...
  return (
    <div className="bg-primary-600 fixed right-0 bottom-0 left-0 p-4 text-white">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <Button variant="outline" className="text-primary-600 bg-white" onClick={handleInstall}>
          Installieren
        </Button>
      </div>
    </div>
...
self.addEventListener('install', (event) => {
  event.waitUntil(addResourcesToCache(['/', '/offline', '/styles/main.css', '/scripts/main.js']))
})
```
...
export function UpdatePrompt() {
  ...
  return (
    <div className="fixed top-4 right-4 rounded-lg bg-white p-4 shadow-lg">
