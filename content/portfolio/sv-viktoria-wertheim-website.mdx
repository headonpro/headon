...
description: "Kompletter Relaunch der SV Viktoria Wertheim Website mit Next.js 15, TypeScript und Supabase. Von statischem HTML zu einer performanten, SEO-optimierten Web-App mit 95+ Lighthouse Score."
client:
...
category: "web"
tags: ["Next.js", "TypeScript", "Tailwind CSS", "Supabase", "Framer Motion", "React Hook Form", "Zod", "SEO", "Performance Optimization"]
image:
...
1. **Performance:** Lighthouse Score 95+ auf allen Geräten
...
- **Vercel**: Edge-Deployment mit globaler CDN-Distribution
...
- Vercel Edge Network: Weltweit schnell, auch bei Traffic-Spikes
- Next.js ISR (Incremental Static Regeneration): Seiten werden on-demand aktualisiert

**Kosten:**
- Hosting: 0€/Monat (Vercel Free Tier)
- Supabase: 0€/Monat (Free Tier, bis 500 MB Datenbank)
- Domain: 12€/Jahr
- **Gesamt: 1€/Monat** (im Vergleich zu vorher 15€/Monat für Shared Hosting)
